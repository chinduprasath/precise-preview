...
const InfluencersPage = () => {
  ...
  const filteredInfluencers = combinedInfluencers.filter(influencer => {
    ...
    const matchesFollowerRange = 
      (influencer.followers_instagram && influencer.followers_instagram >= Number(followerRange[0]) && influencer.followers_instagram <= Number(followerRange[1])) ||
      (influencer.followers_facebook && influencer.followers_facebook >= Number(followerRange[0]) && influencer.followers_facebook <= Number(followerRange[1])) ||
      (influencer.followers_twitter && influencer.followers_twitter >= Number(followerRange[0]) && influencer.followers_twitter <= Number(followerRange[1])) ||
      (influencer.followers_youtube && influencer.followers_youtube >= Number(followerRange[0]) && influencer.followers_youtube <= Number(followerRange[1]));
