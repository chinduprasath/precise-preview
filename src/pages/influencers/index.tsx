  ...
  return (
    ...
    >
      <Avatar className="h-12 w-12">
        <img
          src={influencer.image_url || 'https://picsum.photos/id/1005/200/200'}
          alt={influencer.name}
    ...
    <div className="p-4">
      <div className="flex items-start gap-4 mb-6">
        <Avatar className="h-16 w-16">
          <img src={influencer.image_url || 'https://picsum.photos/id/1005/200/200'} alt={influencer.name} className="h-full w-full object-cover" />
        </Avatar>
        <div className="flex-1">
          ...
          <p className="text-sm text-gray-600 mt-2">{influencer.bio || 'Adventure traveler and photographer'}</p>
      ...
      <div className="border-b">
        <div className="flex">
          <button
            className={`px-4 py-2 border-b-2 ${activeTab === 'profile' ? 'border-primary text-primary' : 'border-transparent'}`}
      ...
      <div className="mt-4">
        ...
        {activeTab === 'prices' && <div>Prices Content</div>}
...
const InfluencersPage = () => {
  ...
  const filteredInfluencers = influencers.filter(influencer => {
    const matchesSearch =
      ...
      influencer.niche?.name.toLowerCase().includes(searchTerm.toLowerCase()) ||
      false ||
