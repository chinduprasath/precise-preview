...
import { Bell, BarChart2, Users, DollarSign, FileText, Video, Film, PieChart, Eye } from 'lucide-react';
        ...
        <main className="flex-1 overflow-auto p-6">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
              ...
              <div>
                <TopUsers users={topBusinessUsers} title="Top Business Users" userType="business" />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
              <div className="lg:col-span-2">
                <PendingOrders orders={pendingOrders} onViewOrder={handleViewOrder} />
              </div>
              
              <div>
                <TopUsers users={topInfluencers} title="Top Influencers" userType="influencer" />
              </div>
            </div>
