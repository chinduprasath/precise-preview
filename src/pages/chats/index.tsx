    ...
    <div className="flex items-center justify-between p-4 border-b">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">Last seen 02:55 pm</p>
        </div>
      </div>
    ...
    <div className="p-4 border-t flex items-center gap-3">
      ...
      <div className="flex-1 relative">
        <Input 
          ...
          className="pl-4 pr-10 py-3 rounded-full border-gray-200"
        />
      </div>
      <Button variant="ghost" size="icon" className="rounded-full">
...
const ChatListItem: React.FC<{ 
  ...
  return (
    <div 
      className={`p-3 flex items-center gap-3 cursor-pointer border-b ${isActive ? 'bg-gray-100' : 'hover:bg-gray-50'}`}
      onClick={onClick}
    >
      <Avatar>
        <img src={influencer.avatar} alt={influencer.name} className="h-full w-full object-cover" />
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-sm text-gray-500 truncate">{influencer.lastMessage}</p>
      </div>
    </div>
  );
};
            ...
            <div className="p-4 border-b">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 pr-4 py-2 w-full rounded-md border-gray-200"
                  value={searchQuery}
