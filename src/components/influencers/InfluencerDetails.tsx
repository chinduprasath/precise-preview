    ...
    <div className="w-full">
      ...
      <div className="flex justify-between mb-6 mx-[30px]">
        <div className="flex flex-col items-center">
          ...
          <span className="text-sm font-semibold">{formatNumber(followers.instagram || 0)}</span>
        </div>
        <div className="flex flex-col items-center">
          ...
          <span className="text-sm font-semibold">{formatNumber(followers.facebook || 0)}</span>
        </div>
        <div className="flex flex-col items-center">
          ...
          <span className="text-sm font-semibold">{formatNumber(followers.youtube || 0)}</span>
        </div>
        <div className="flex flex-col items-center">
          ...
          <span className="text-sm font-semibold">{formatNumber(followers.twitter || 0)}</span>
        </div>
      </div>
