    ...
    <section className="py-20 px-6 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 opacity-0 animate-fadeInUp">What Our Clients Say</h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto opacity-0 animate-fadeInUp [animation-delay:100ms]">Hear from businesses who have transformed their marketing with InfluexKonnect.</p>
        </div>
