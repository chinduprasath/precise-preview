    ...
    <section id={id} className="py-20 px-6 bg-gradient-to-b from-white to-gray-50">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 opacity-0 animate-fadeInUp">About InfluexKonnect</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          <div className="bg-white rounded-xl p-8 shadow-sm text-center transition-all duration-300 hover:shadow-lg hover:scale-105 hover:-translate-y-1 opacity-0 animate-fadeInScale [animation-delay:400ms]">
          ...
          <div className="bg-white rounded-xl p-8 shadow-sm text-center transition-all duration-300 hover:shadow-lg hover:scale-105 hover:-translate-y-1 opacity-0 animate-fadeInScale [animation-delay:500ms]">
            <div className="w-16 h-16 rounded-full bg-primary/10 flex items-center justify-center mx-auto mb-6 transition-transform duration-300 hover:scale-110 hover:rotate-3">
          ...
          <div className="bg-white rounded-xl p-8 shadow-sm text-center transition-all duration-300 hover:shadow-lg hover:scale-105 hover:-translate-y-1 opacity-0 animate-fadeInScale [animation-delay:600ms]">
            <div className="w-16 h-16 rounded-full bg-primary/10 flex items-center justify-center mx-auto mb-6 transition-transform duration-300 hover:scale-110 hover:rotate-3">
          ...
          <div className="bg-white rounded-xl p-8 shadow-sm text-center transition-all duration-300 hover:shadow-lg hover:scale-105 hover:-translate-y-1 opacity-0 animate-fadeInScale [animation-delay:700ms]">
            <div className="w-16 h-16 rounded-full bg-primary/10 flex items-center justify-center mx-auto mb-6 transition-transform duration-300 hover:scale-110 hover:rotate-3">
        ...
        <div className="bg-white rounded-xl p-10 shadow-sm opacity-0 animate-fadeInUp [animation-delay:800ms]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="relative opacity-0 animate-fadeInUp [animation-delay:900ms]">
              <div className="w-12 h-12 rounded-full bg-primary text-white flex items-center justify-center font-bold text-xl mb-4 transition-transform duration-300 hover:scale-110">1</div>
            ...
            <div className="relative opacity-0 animate-fadeInUp [animation-delay:1000ms]">
              <div className="w-12 h-12 rounded-full bg-primary text-white flex items-center justify-center font-bold text-xl mb-4 transition-transform duration-300 hover:scale-110">2</div>
            ...
            <div className="opacity-0 animate-fadeInUp [animation-delay:1100ms]">
              <div className="w-12 h-12 rounded-full bg-primary text-white flex items-center justify-center font-bold text-xl mb-4 transition-transform duration-300 hover:scale-110">3</div>
